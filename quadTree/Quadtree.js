...
Rectangle.prototype.display = function(ctx, color) {
    col = color ||  "#00FF0033";
    ctx.save();
    ctx.strokeStyle = col;
...
Quadtree.prototype.query = function(range, found) {
    ...
    if(!this.boundary.intersects(range)) {
        // in case of a checking out of the quadtree zone (with a mouse following option for exemple)
        // return a empty array, avoiding "found undefined" error
        found = []
        return found;
    } else {
